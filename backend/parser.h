...
#include "graph.h"   /* for Session */

#define MAX_ITEMS      64
#define MAX_NAME_LEN  128

/* ---- Data structures matching the JSON input schema ---- */
...
/* Parse the JSON file at 'filepath' into *data.
   Returns 1 on success, 0 on error. */
int parseInputJSON(const char *filepath, InputData *data);

/* Expand input data into individual Session records (one per lecture).
   sessions[] must have space for maxSessions entries.
